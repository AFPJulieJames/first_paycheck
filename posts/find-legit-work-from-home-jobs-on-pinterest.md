...
- Does following the pin lead to a request for money to "get started," join a program, or buy a starter kit? That is the [number-one scam red flag](/blog/work-from-home-scam-red-flags), not a job.
- Is the income claim specific and huge with little work attached? Hype, not a plan.
- Can you tell exactly what the work is and who pays for it? If it is a vague "system" or "method," there is usually nothing real underneath. The same goes for anything that pays you mainly to recruit other people, which is how you [spot an MLM](/blog/how-to-tell-if-a-job-is-an-mlm).
