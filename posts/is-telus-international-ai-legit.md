...
type: review
rating: 3.5
reviewOf: Telus International AI
---
...
Some raters work through Microsoft's **UHRS** platform via Telus, which means you may be asked to log in with a Microsoft account during onboarding. That can feel alarming, but using a Microsoft work platform is a normal part of this kind of rating work. The real rule still holds: a legitimate platform never asks you to **pay to start** or to **deposit a check and send money back**. If anything in your onboarding involves money flowing from you, stop and run it through the [Scam Smell Test](/#scam), because impersonation scams do target rater applicants.
