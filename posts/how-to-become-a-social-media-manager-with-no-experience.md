...
1. **Pick one platform and one niche.** "I help local cafes and salons on Instagram" beats "I do all social media." Specific is hireable.
2. **Build proof.** Run your own account in that niche for a few weeks, or offer to manage one account free or cheap for a small business or nonprofit in exchange for a testimonial and results you can show.
3. **Make a one-page portfolio.** Before-and-after screenshots, sample posts you designed, and a short note on what you would do for a client. A free design tool is enough.
4. **Learn the basic tools.** A scheduler, a free graphics tool, and a content-calendar template. That is genuinely most of the stack.
5. **Pitch small, local, and specific.** Message businesses whose social media is neglected. Owners with empty or abandoned accounts are your best first clients.
6. **Price for a retainer, deliver consistently, then raise rates** once you have a result and a testimonial.

## Skip the expensive courses

You will see ads promising a six-figure social media agency if you buy a $2,000 program. You do not need it. Everything above can be learned free, and the only thing that gets you hired is a small portfolio and one happy client. If a "mentor" is selling the dream harder than the work, that is a [hype flag](/blog/are-ai-side-hustles-worth-it), not a shortcut.

## Watch for the usual scams

When you start pitching, you may get fake "clients" too. No real client sends you a check up front and asks you to forward part of it to a "vendor," that is the [fake-check scam](/blog/fake-check-job-scams). And you should never pay to join a "social media manager network." Run anything odd through the [Scam Smell Test](/#scam).
