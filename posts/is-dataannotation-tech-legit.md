...
DataAnnotation pays you, it never asks you to pay it. There is no fee to join and no check-and-send-back nonsense, so if you ever see those, you are looking at an impersonator running the [fake-check scam](/blog/fake-check-job-scams), not the real platform. Apply only through the official site, and sanity-check anything odd with the [Scam Smell Test](/#scam).
