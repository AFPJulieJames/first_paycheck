...
A lot of these now wear an AI costume: "AI trainer," "data annotation specialist," "online assessor," "product optimizer." Real versions of some of these jobs do exist (see our honest look at [data annotation jobs](/blog/data-annotation-jobs-from-home-no-experience)), which is exactly why the scam works. The fake ones skip the normal hiring steps and get you doing unpaid "assessment" tasks, or steer you toward that deposit.
...
You do not need to memorize all of this. If a message feels off, paste it into the free [Scam Smell Test](/#scam). It scans for these exact patterns, highlights the phrases that triggered them, and tells you plainly whether to walk away. It is FTC-aligned and costs nothing. For more on the broader playbook, see our guide to [work-from-home scam red flags](/blog/work-from-home-scam-red-flags).
